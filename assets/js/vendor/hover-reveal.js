 ...
 */
{
    ...
    class HoverImgFx1 {
        constructor(el) {
            ...
            this.DOM.reveal.innerHTML = `<div class="bd-img-reveal-wrapper__inner">
                <div class="bd-img-reveal-wrapper__img" style="background-image:url(${this.DOM.el.dataset.img ? this.DOM.el.dataset.img: ''})">
                    <div class="bd-hover-wrapper"> 
                        <span class="bd-hover-subtitle">${this.DOM.el.dataset.subtitle ? this.DOM.el.dataset.subtitle: ''}</span>
                        <h3 class="bd-hover-title">${this.DOM.el.dataset.title ? this.DOM.el.dataset.title: ''}</h3>
                        <p>${this.DOM.el.dataset.desc ? this.DOM.el.dataset.desc: ''}</p>
                        <div class="bd-hover-meta">
                            <span>
            ...
            this.DOM.reveal.innerHTML = `<div class="bd-img-reveal-wrapper__inner">
                <div class="bd-img-reveal-wrapper__img" style="background-image:url(${this.DOM.el.dataset.img ? this.DOM.el.dataset.img: ''})">
                    <div class="portfolio__hover-wrapper">
                        <h5 class="portfolio__hover-title">${this.DOM.el.dataset.title ? this.DOM.el.dataset.title: ''}</h5>
    ...
    class HoverImgFx5 {
        constructor(el) {
            ...
            this.DOM.reveal = document.createElement('div');
            this.DOM.reveal.className = 'bd-img-reveal-wrapper';
            this.DOM.reveal.innerHTML = `<div class="bd-img-reveal-wrapper__deco"></div>
            <div class="bd-img-reveal-wrapper__img" style="background-image:url(${this.DOM.el.dataset.img ? this.DOM.el.dataset.img: ''})">
            <div class="bd-hover-wrapper"> 
                <span class="bd-hover-subtitle">${this.DOM.el.dataset.subtitle ? this.DOM.el.dataset.subtitle: ''}</span>
                <h3 class="bd-hover-title">${this.DOM.el.dataset.title ? this.DOM.el.dataset.title: ''}</h3>
    ...
    class HoverImgFx6 {
        constructor(el) {
            ...
            this.DOM.reveal.className = 'bd-img-reveal-wrapper';
            this.DOM.reveal.style.overflow = 'hidden';
            this.DOM.reveal.innerHTML = `<div class="bd-img-reveal-wrapper__deco"></div><div class="bd-img-reveal-wrapper__inner"><div class="bd-img-reveal-wrapper__img" style="background-image:url(${this.DOM.el.dataset.img})"><span class="bd-hover-subtitle">${this.DOM.el.dataset.subtitle ? this.DOM.el.dataset.subtitle: ''}</span> <h3 class="bd-hover-title">${this.DOM.el.dataset.title ? this.DOM.el.dataset.title: ''}</h3><p class="bd-hover-desc">${this.DOM.el.dataset.desc ? this.DOM.el.dataset.desc: ''}</p></div></div>`;
            this.DOM.el.appendChild(this.DOM.reveal);
            this.DOM.revealInner = this.DOM.reveal.querySelector('.bd-img-reveal-wrapper__inner');
            this.DOM.revealInner.style.overflow = 'hidden';
            this.DOM.revealDeco = this.DOM.reveal.querySelector('.bd-img-reveal-wrapper__deco');
    ...
    class HoverImgFx12 {
        constructor(el) {
            ...
            for (let i = 0; i <= this.totalDecos - 1; ++i) {
                inner += '<div class="bd-img-reveal-wrapper__deco"></div>';
            }
            inner += `<div class="bd-img-reveal-wrapper__inner"><div class="bd-img-reveal-wrapper__img" style="background-image:url(${this.DOM.el.dataset.img})"><span class="bd-hover-subtitle">${this.DOM.el.dataset.subtitle ? this.DOM.el.dataset.subtitle: ''}</span> <h3 class="bd-hover-title">${this.DOM.el.dataset.title ? this.DOM.el.dataset.title: ''}</h3><p class="bd-hover-desc">${this.DOM.el.dataset.desc ? this.DOM.el.dataset.desc: ''}</p></div></div>`
    ...
    class HoverImgFx13 {
        constructor(el) {
            ...
            for (let i = 0; i <= this.totalImages - 1; ++i) {
                inner += `<div class="bd-img-reveal-wrapper__img" style="position: absolute; background-image:url(${this.DOM.el.dataset.img})"><span class="bd-hover-subtitle">${this.DOM.el.dataset.subtitle ? this.DOM.el.dataset.subtitle: ''}</span> <h3 class="bd-hover-title">${this.DOM.el.dataset.title ? this.DOM.el.dataset.title: ''}</h3><p class="bd-hover-desc">${this.DOM.el.dataset.desc ? this.DOM.el.dataset.desc: ''}</p></div>`;
            }
            this.DOM.reveal.innerHTML = inner;
            this.DOM.el.appendChild(this.DOM.reveal);
    ...
    class HoverImgFx14 {
        constructor(el) {
            ...
            for (let i = 0, len = imgsArr.length; i <= len - 1; ++i) {
                inner += `<div class="bd-img-reveal-wrapper__img" style="transform-origin:0% 0%;opacity:0;position:absolute;background-image:url(${imgsArr[i]})"><span class="bd-hover-subtitle">${this.DOM.el.dataset.subtitle ? this.DOM.el.dataset.subtitle: ''}</span> <h3 class="bd-hover-title">${this.DOM.el.dataset.title ? this.DOM.el.dataset.title: ''}</h3><p class="bd-hover-desc">${this.DOM.el.dataset.desc ? this.DOM.el.dataset.desc: ''}</p></div>`;
            }
            this.DOM.reveal.innerHTML = inner;
            this.DOM.el.appendChild(this.DOM.reveal);
            this.DOM.revealImgs = [...this.DOM.reveal.querySelectorAll('.bd-img-reveal-wrapper__img')];
    ...
    class HoverImgFx20 {
        constructor(el) {
            ...
            let inner = '';
            for (let i = 0; i <= this.totalImages - 1; ++i) {
                inner += i === this.totalImages - 1 ? `<div class="bd-img-reveal-wrapper__img" style="position: absolute; background-image:url(${this.DOM.el.dataset.img})"><span class="bd-hover-subtitle">${this.DOM.el.dataset.subtitle ? this.DOM.el.dataset.subtitle: ''}</span> <h3 class="bd-hover-title">${this.DOM.el.dataset.title ? this.DOM.el.dataset.title: ''}</h3><p class="bd-hover-desc">${this.DOM.el.dataset.desc ? this.DOM.el.dataset.desc: ''}</p></div>` :
                    `<div class="bd-img-reveal-wrapper__img" style="filter: hue-rotate(60deg) saturate(5); position: absolute; background-image:url(${this.DOM.el.dataset.img})"></div>`;
            }
            this.DOM.reveal.innerHTML = inner;
            this.DOM.el.appendChild(this.DOM.reveal);
            this.DOM.revealImgs = [...this.DOM.reveal.querySelectorAll('.bd-img-reveal-wrapper__img')];
    ...
    class HoverImgFx21 {
        constructor(el) {
            ...
            for (let i = 0; i <= this.totalImages - 1; ++i) {
                inner += i === this.totalImages - 1 ? `<div class="bd-img-reveal-wrapper__img" style="position: absolute; background-image:url(${this.DOM.el.dataset.img})"><span class="bd-hover-subtitle">${this.DOM.el.dataset.subtitle ? this.DOM.el.dataset.subtitle: ''}</span> <h3 class="bd-hover-title">${this.DOM.el.dataset.title ? this.DOM.el.dataset.title: ''}</h3><p class="bd-hover-desc">${this.DOM.el.dataset.desc ? this.DOM.el.dataset.desc: ''}</p></div>` :
                    `<div class="bd-img-reveal-wrapper__img" style="filter: hue-rotate(90deg) saturate(9); position: absolute; background-image:url(${this.DOM.el.dataset.img})"></div>`;
            }
            this.DOM.reveal.innerHTML = inner;
            this.DOM.el.appendChild(this.DOM.reveal);
            this.DOM.revealImgs = [...this.DOM.reveal.querySelectorAll('.bd-img-reveal-wrapper__img')];
    ...
    class HoverImgFx22 {
        constructor(el) {
            ...
            this.DOM.reveal = document.createElement('div');
            this.DOM.reveal.className = 'bd-img-reveal-wrapper';
            this.DOM.reveal.innerHTML = `<div class="bd-img-reveal-wrapper__img" style="background-image:url(${this.DOM.el.dataset.img})"><span class="bd-hover-subtitle">${this.DOM.el.dataset.subtitle ? this.DOM.el.dataset.subtitle: ''}</span> <h3 class="bd-hover-title">${this.DOM.el.dataset.title ? this.DOM.el.dataset.title: ''}</h3><p class="bd-hover-desc">${this.DOM.el.dataset.desc ? this.DOM.el.dataset.desc: ''}</p></div>`;
            this.DOM.el.appendChild(this.DOM.reveal);
